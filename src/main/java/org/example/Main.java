...
public class Main {
    ...
    public static void main(String[] args) {
       ...
       System.out.println(WordCounter.calculatedWord());
        ...
        employees.add(new Employee(1, "nida", "türkay"));
        employees.add(new Employee(1, "nida", "türkay"));
        employees.add(new Employee(1, "nida", "türkay"));
        employees.add(new Employee(2, "ahmet", "demir"));
        employees.add(new Employee(2, "ayşe", "yıldız"));
        employees.add(new Employee(3, "zeynep", "çiçek"));
        employees.add(new Employee(4, "ali", "kişi"));
